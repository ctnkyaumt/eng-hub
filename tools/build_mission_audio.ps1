...
# Generate portable WAV clips for the Listen & Find missions using an installed
# Windows English voice. The clips are committed with the app, so playback on
# the classroom machine does not depend on its browser voices or the internet.
